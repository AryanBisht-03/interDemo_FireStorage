...
import com.example.interndemostorage.databinding.FragmentVideosBinding;
...
public class VideosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVideosBinding.inflate(getLayoutInflater(),container,false);
        database = FirebaseDatabase.getInstance();
        storage = FirebaseStorage.getInstance();

        reference = database.getReference().child("Videos");
        ref = storage.getReference().child("Videos");
        list = new ArrayList<>();
        ...
        binding.recyclerViewVideo.setAdapter(adapters);
